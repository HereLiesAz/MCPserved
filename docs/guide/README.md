...
| [remote-access](remote-access.md) | Opt-in, off-by-default paths for a host with no local network path to the phone: a wider bind for a private mesh, and a relay for the sealed-frame protocol. |
